...
const nextSpecs = [
  ...
  ["ai-capable-hiring", "AI-Capable Hiring", "AI-Capable Hiring: Evaluate Real AI Work"],
  ...
  [
    "ai-work-sample-assessment",
    "AI Work Sample Assessment",
    "AI Work Sample Assessment: Review Process, Not Polish",
    "Evaluate AI-assisted work samples with evidence, revision history, judgment, and role-specific review criteria.",
  ],
  [
    "how-to-prove-ai-skills",
    "How to Prove AI Skills",
    "How to Prove AI Skills Without Fake Tests or Claims",
    "Show AI capability through work samples, proof artifacts, decisions, revisions, and evidence a reviewer can inspect.",
  ],
  [
    "how-to-show-ai-work-on-a-resume",
    "How to Show AI Work on a Resume",
    "How to Show AI Work on a Resume With Proof",
    "Turn AI skill claims on a resume into linked proof artifacts, AI work samples, and inspectable project evidence.",
  ],
  [
    "how-to-tell-if-a-resume-was-written-by-ai",
    "How to Tell if a Resume Was Written by AI",
    "How to Tell if a Resume Was Written by AI",
    "Look beyond AI-written polish and evaluate whether a resume is backed by real work, judgment, and proof artifacts.",
  ],
  [
    "how-to-write-a-resume-in-2026",
    "How to Write a Resume in 2026",
    "How to Write a Resume in 2026: Add Proof, Not Just Polish",
    "A modern resume should connect claims to proof of work, AI-assisted projects, and evidence hiring teams can inspect.",
  ],
] as const;
...
export const nextAcquisitionPages: SeoPage[] = nextSpecs.map((spec, index) => ({
  ...
  title: spec[1],
  seoTitle: spec[2],
  metaDescription: spec[3] ?? `${spec[1]} from ProofOfAIWork: turn AI capability claims into inspectable evidence.`,
  ...
  primaryCta: index < 18 ? "Use the proof framework" : "Create proof of AI work",
  secondaryCta: "Create proof of AI work",
  internalLinks: ["/ai-capability-proof", "/ai-work-samples", "/your-ai-resume", "/examples"],
