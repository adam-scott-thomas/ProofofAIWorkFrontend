...
export default function WorkProfile() {
  ...
  const shareData = {
    ...
    proofUrl: "https://poaw.io/p/alexchen-q1-2026",
      ...
      <div className="mx-auto max-w-6xl px-8 py-8">
        ...
        <Card className="mb-8 border border-[rgba(0,0,0,0.08)] bg-white p-8 shadow-sm">
          <div className="mb-8 flex items-start justify-between">
            <div>
              ...
              <div className="text-[15px] text-[#717182]">
                Based on {mockWorkProfile.project_count} projects, {mockWorkProfile.conversation_count} conversations
              </div>
              <div className="mt-1 text-[13px] text-[#717182] font-mono">
                Evaluated {new Date(mockWorkProfile.evaluated_at).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
              </div>
            </div>
          ...
          <div className="mt-8 flex items-center gap-3 border-t border-[rgba(0,0,0,0.06)] pt-8">
            ...
            {mockWorkProfile.archetype.secondary.map((arch) => (
